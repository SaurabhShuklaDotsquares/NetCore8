(function ($) {
    function ContentManagerIndex() {
        ...
        function initializeGrid() {
            ...
            accomodationGrid = new Global.GridHelper('#grid-ContentManager-details', {
                "columnDefs": [
                    { "targets": [0], "visible": false },
                    { "targets": [1], "visible": true, "sortable": false, "searchable": false },
                    { "targets": [2], "sortable": true, "searchable": true },
                    {
                        "targets": [3], "sortable": false, "searchable": false, "data": "3",
                    ...
                    {
                        "targets": [4], "data": "0", "searchable": false, "sortable": false,
                        "render": function (data, type, row, meta) {
                            var actionLink = '';
        ...
        function initGridControlsWithEvents() {
            ...
            $('.switchBox').bootstrapSwitch()
                .on('switchChange.bootstrapSwitch', function () {
                    ...
                    $.get(domain + '/ContentManager/UpdateStatus', { id: this.value }, function (result) {
                        if (!result.isSuccess) {
    ...
    $(function () {
        var self = new ContentManagerIndex();
        self.init();
    })
})(jQuery)