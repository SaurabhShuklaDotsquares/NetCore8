    ...
    function CountryIndex() {
        ...
        function initializeGrid() {
            ...
            NotificationsGrid = new Global.GridHelper('#grid-notifications-details', {
                "columnDefs": [
...

                    {
                        ...
                        "render": function (data, type, row, meta) {
                            ...
                            actionLink += $("<a/>", {
                                href: "/Admin/ManageNotifications/ViewNotification/" + row[0],
                                id: "viewModalId",
                ...
                "bAutoWidth": false,
                "stateSave": false,
                "sAjaxSource": "/Admin/" + "ManageNotifications/Index",
            ...
            $(document).on("submit", "#newsLetterForm", function (event) {
                ...
                if ($("#notificationType").val() == "") {
                    Global.ShowMessage('User is required', Global.MessageType.Error);
                    return false;
                }
               else if (!editor1.getData().trim()) {
                    Global.ShowMessage('Description is required', Global.MessageType.Error);
                    return false;
                }
                else if (editor1.getData().trim().length>500) {
                    Global.ShowMessage('Description should be less than 500 characters', Global.MessageType.Error);
                    return false;
                }
                ...
                $.ajax({
                    ...
                    success: function (result) {
                        if (result.isSuccess == true) {
                            ...
                            setTimeout(function () { window.location.assign("/Admin/ManageNotifications/Index"); }, 8000)
                            //initializeGrid();
